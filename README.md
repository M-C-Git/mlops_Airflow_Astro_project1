...
Initiate Your Project Locally
============================
1. Initiate the project by running 'astro init'
...
This command will spin up 4 Standard Afirflow Docker containers on your machine, each for a different Airflow component:
